...
class Rps_game:
    ...
    def get_prediction(self):
        ...
        self.countdown_timer(3) # calls the countdown function: The user is prompted to press enter and then a 3 second countdown is given for each round
    ...
    def play(self):
        ...
        while game_active:
            ...
            cpu_choice = self.get_computer_choice()
            ...
            if user_wins == self.winning_score:  # checks if the "winning_score" has been reached by user. Print congratulatory message if true
                print(f"""\n
        Well done! You win!!!
        ...
        CPU : {computer_wins}""")
            ...
            elif computer_wins == self.winning_score: # checks if the "winning_score" has been reached by cpu and prints message if true
                print(f"""\n
        Sorry...You lose!!!
